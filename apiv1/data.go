...
// DataHistoryNReq 按上N条查询
type DataHistoryNReq struct {
	g.Meta     `path:"/data/historyN" method:"post" tags:"Data" summary:"按上N条获取历史数据"`
